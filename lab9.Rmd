...
[**Q1 **]{.ul}
:::
Please adapte the code chunk above to produce the following maps: 

 * crash involving automobiles using the color palette "PuBuGn"
 * crash involving trailors using the color palette "YlOrRd"
 * crash involving buses using the color palette "Greens"

::::



### 9.6 Kernel Density Map

**Hint** You would need to re-write this section (9.6) to answer **Q2**. 

**Q2**: Please produce a kernel density map for crash involving trucks. 
