...
#### 3.3.1 Population Data 2010-2022
...
Let's improve the plot by giving more instructions in terms of how we want the plot illustrates the data. Please run the code blow and observe how this plot is different from the previous one. 
...
In **lab3 report**, please report what are the purpose of these codes: 
...
* apply a minimal theme ``` theme_minimal() ```. The package ``` ggplot ``` has many pre-defined themes (see [here](https://ggplot2.tidyverse.org/reference/ggtheme.html)).  
