...
Let's combine the two data frame ``` pop_cos ``` and ``` pop_buf ``` to make things easier. Remember that we have checked their column names in Step 3.3.2. One condition to combine rows together is that they need to have the same column names.  
