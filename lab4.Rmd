...
Check the current working directory. You should see a path ending with something similar to ``` COURSEFOLDER/lab4 ```. If not, please close the RProject, go back to [Section 4.2.1](https://fuzhen-yin.github.io/uccs_geoviz/lab4.html#421_Organizing_Folders__Sub-folders) to organize 
```{r, eval=FALSE, class.source = "nocopy"}
# working directory
getwd()
```
