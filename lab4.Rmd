...
* Re-write the script by yourself. 
  + R is case-sensitive
  + organize & structure your script 
...
We will read the data from the "_data_" folder. Please make sure you can see **four** folders in your **data** folder as shown in Figure 4.1. 
