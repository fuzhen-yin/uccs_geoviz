...
![Figure 1.1.1: Creating a course folder and a series of sub-folders for labs](figs/lab1_organizing folder.png){width=70%} 
<br>
<br>
...
![Figure 1.1.2: Lauching RStudio](figs/lab1_launch_Rstudio.png){width=40%}
...
![Figure 1.1.3: The interface of RStudio](figs/lab1_rstudio_interface.png){width=100%}
...
![Figure 1.1.4: New script](figs/lab1_new_script.png){width=100%}
...
![Figure 1.1.4: Save script to folder "lab1"](figs/lab1_save_script.png){width=70%}

After creating and saving the new script, you should see something similar to Figure 1.5. \
![Figure 1.1.5: Interface after creating a new script](figs/lab1_Window.png){width=100%}
...
2+5+8
```
![Figure 1.1.6: Simple coding - math](figs/lab1_first command_math.png){width=100%}
...
![Figure 1.1.7: Close & Save an R Project](figs/lab1_closeproject_save.png){width=50%}
